...
function formHtml(params: {
  ...
  const resourceText = params.resource?.href ?? "dpkr helix MCP endpoint";
...
<html lang="en">
  <head>
    ...
    <title>Connect dpkr helix</title>
    <style>
...
${hiddenFields}
        ...
        <button type="submit">Authorize dpkr helix</button>
      </form>
    </main>
  </body>
</html>`;
